...
server <- function(input, output, session) {
  ...
  observeEvent(input$runexample, {
    #ngenes
    output$ngene <- renderText({paste("Number of genes: ", dim(ctdemo)[1], " [First 10 rows displayed]")})
    #nsamples
    output$nsample <- renderText({paste("Number of genes: ", (dim(ctdemo)[2])-1, " [First 10 rows displayed]")})
